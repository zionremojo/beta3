!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(((e = e || self).Leaflet = e.Leaflet || {},
    ...
    var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        removeLayer: function(e) {
            ...
            e.clusterShow && e.clusterShow())) : (!this._arraySplice(this._needsClustering, e) && this.hasLayer(e) && this._needsRemoving.push({
                layer: e,
                latlng: e._latlng
            }),
            this.fire("layerremove", {
        ...
        addLayers: function(i, r) {
            if (!L.Util.isArray(i))
                return this.addLayer(i);
            var n, s = this._featureGroup, o = this._nonPointGroup, a = this.options.chunkedLoading, h = this.options.chunkInterval, l = this.options.chunkProgress, u = i.length, _ = 0, d = !0;
            if (this._map) {
                var p = (new Date).getTime()
                  , c = L.bind(function() {
                    var e = (new Date).getTime();
                    for (this._map && this._unspiderfy && this._unspiderfy(); _ < u; _++) {
                        if (a && _ % 200 == 0) {
                            var t = (new Date).getTime() - e;
                            if (h < t)
                                break
                        }
                        (n = i[_])instanceof L.LayerGroup ? (d && (i = i.slice(),
                        d = !1),
                        this._extractNonGroupLayers(n, i),
                        u = i.length) : n.getLatLng ? !this.hasLayer(n) && (this._addLayer(n, this._maxZoom),
                        r || this.fire("layeradd", {
                            layer: n
                        }),
                        n.__parent && 2 === n.__parent.getChildCount()) && (t = (t = n.__parent.getAllChildMarkers())[0] === n ? t[1] : t[0],
                        s.removeLayer(t)) : (o.addLayer(n),
                        r || this.fire("layeradd", {
                            layer: n
                        }))
                    }
                    l && l(_, u, (new Date).getTime() - p),
                    _ === u ? (this._topClusterLevel._recalculateBounds(),
                    this._refreshClustersIcons(),
                ...
                for (var e = this._needsClustering; _ < u; _++)
                    (n = i[_])instanceof L.LayerGroup ? (d && (i = i.slice(),
                    d = !1),
                    this._extractNonGroupLayers(n, i),
                    u = i.length) : n.getLatLng ? this.hasLayer(n) || e.push(n) : o.addLayer(n);
            return this
        },
        removeLayers: function(e) {
            var t, i = e.length, r = this._featureGroup, n = this._nonPointGroup, s = !0;
            if (!this._map) {
                for (h = 0; h < i; h++)
                    (t = e[h])instanceof L.LayerGroup ? (s && (e = e.slice(),
                    s = !1),
                    this._extractNonGroupLayers(t, e),
                    i = e.length) : (this._arraySplice(this._needsClustering, t),
                    n.removeLayer(t),
                    this.hasLayer(t) && this._needsRemoving.push({
                        layer: t,
                        latlng: t._latlng
                    }),
                    this.fire("layerremove", {
            ...
            if (this._unspiderfy) {
                this._unspiderfy();
                for (var o = e.slice(), a = i, h = 0; h < a; h++)
                    (t = o[h])instanceof L.LayerGroup ? (this._extractNonGroupLayers(t, o),
                    a = o.length) : this._unspiderfyLayer(t)
            }
            for (h = 0; h < i; h++)
                (t = e[h])instanceof L.LayerGroup ? (s && (e = e.slice(),
                s = !1),
                this._extractNonGroupLayers(t, e),
                i = e.length) : t.__parent ? (this._removeLayer(t, !0, !0),
                this.fire("layerremove", {
                    layer: t
                }),
                r.hasLayer(t) && (r.removeLayer(t),
                t.clusterShow && t.clusterShow())) : (n.removeLayer(t),
                this.fire("layerremove", {
                    layer: t
                }));
        ...
        eachLayer: function(e, t) {
            var i, r, n, s = this._needsClustering.slice(), o = this._needsRemoving;
        ...
        hasLayer: function(e) {
            if (!e)
                return !1;
            for (var t = this._needsClustering, i = t.length - 1; 0 <= i; i--)
                if (t[i] === e)
                    return !0;
            for (i = (t = this._needsRemoving).length - 1; 0 <= i; i--)
                if (t[i].layer === e)
                    return !1;
        ...
        zoomToShowLayer: function(e, t) {
            ...
            var r = function() {
                !i.hasLayer(e) && !i.hasLayer(e.__parent) || this._inZoomAnimation || (this._map.off("moveend", r, this),
                this.off("animationend", r, this),
                i.hasLayer(e) ? t() : e.__parent._icon && (this.once("spiderfied", t, this),
                e.__parent.spiderfy()))
            };
            e._icon && this._map.getBounds().contains(e.getLatLng()) ? t() : e.__parent._zoom < Math.round(this._map._zoom) ? (this._map.on("moveend", r, this),
            this._map.panTo(e.getLatLng())) : (this._map.on("moveend", r, this),
        ...
        onAdd: function(e) {
            ...
            t = 0,
            i = this._needsRemoving.length; t < i; t++)
        ...
        _childMarkerMoved: function(e) {
            var t;
            this._ignoreMove || e.target.__dragStart || (t = e.target._popup && e.target._popup.isOpen(),
        ...
        _defaultIconCreateFunction: function(e) {
            var t = e.getChildCount()
              , e = " marker-cluster-";
            return e += t < 10 ? "small" : t < 100 ? "medium" : "large",
            new L.DivIcon({
        ...
        _moveEnd: function() {
            var e;
            this._inZoomAnimation || (e = this._getExpandedVisibleBounds(),
        ...
        _addLayer: function(e, t) {
            ...
            e.on(this._childMarkerEventHandlers, this); n <= t; t--) {
                var s = this._map.project(e.getLatLng(), t)
                  , o = i[t].getNearObject(s);
                if (o)
                    return o._addChild(e),
                    void (e.__parent = o);
                if (o = r[t].getNearObject(s)) {
                    var a = o.__parent;
                    a && this._removeLayer(o, !1);
                    var h = new this._markerCluster(this,t,o,e);
                    i[t].addObject(h, this._map.project(h._cLatLng, t)),
                    o.__parent = h;
                    for (var l = e.__parent = h, u = t - 1; u > a._zoom; u--)
                        l = new this._markerCluster(this,u,l),
                        i[u].addObject(l, this._map.project(o.getLatLng(), u));
                    return a._addChild(l),
                    void this._removeFromGridUnclustered(o, t)
                }
                r[t].addObject(e, s)
            }
        ...
        _animationAddLayerNonAnimated: function(e, t) {
            t === e ? this._featureGroup.addLayer(e) : 2 === t._childCount ? (t._addToMap(),
            e = t.getAllChildMarkers(),
            this._featureGroup.removeLayer(e[0]),
            this._featureGroup.removeLayer(e[1])) : t._updateIcon()
        },
        _extractNonGroupLayers: function(e, t) {
            var i, r = e.getLayers(), n = 0;
    ...
    L.MarkerClusterGroup.include({
        ...
        _withAnimation: {
            ...
            _animationZoomIn: function(n, s) {
                var o, a = this._getExpandedVisibleBounds(), h = this._featureGroup, e = Math.floor(this._map.getMinZoom());
                this._ignoreMove = !0,
                this._topClusterLevel._recursively(a, n, e, function(e) {
                    var t, i = e._latlng, r = e._markers;
                    for (a.contains(i) || (i = null),
                    e._isSingleParent() && n + 1 === s ? (h.removeLayer(e),
                    e._recursivelyAddChildrenToMap(null, s, a)) : (e.clusterHide(),
            ...
            _animationAddLayer: function(e, t) {
                ...
                r.addLayer(e),
                t !== e && (2 < t._childCount ? (t._updateIcon(),
                this._forceLayout(),
        ...
        _animationZoomOutSingle: function(t, i, r) {
            ...
            this._enqueue(function() {
                var e;
                1 === t._childCount ? (e = t._markers[0],
                this._ignoreMove = !0,
                e.setLatLng(e.getLatLng()),
                this._ignoreMove = !1,
                e.clusterShow && e.clusterShow()) : t._recursively(n, r, s, function(e) {
    ...
    var i = L.MarkerCluster = L.Marker.extend({
        ...
        zoomToBounds: function(e) {
            for (var t = this._childClusters.slice(), i = this._group._map, r = i.getBoundsZoom(this._bounds), n = this._zoom + 1, i = i.getZoom(); 0 < t.length && n < r; ) {
                n++;
                for (var s = [], o = 0; o < t.length; o++)
                    s = s.concat(t[o]._childClusters);
                t = s
            }
            n < r ? this._group._map.setView(this._latlng, n) : r <= i ? this._group._map.setView(this._latlng, i + 1) : this._group._map.fitBounds(this._bounds, e)
        },
        getBounds: function() {
            var e = new L.LatLngBounds;
        ...
        _recalculateBounds: function() {
            var e, t, i, r = this._markers, n = this._childClusters, s = 0, o = 0, a = this._childCount;
            if (0 !== a) {
                ...
                for (e = 0; e < n.length; e++)
                    (i = n[e])._boundsNeedUpdate && i._recalculateBounds(),
                    this._bounds.extend(i._bounds),
                    t = i._wLatLng,
                    i = i._childCount,
                    s += t.lat * i,
                    o += t.lng * i;
                this._latlng = this._wLatLng = new L.LatLng(s / a,o / a),
        ...
        _recursivelyAnimateChildrenIn: function(e, n, t) {
            this._recursively(e, this._group._map.getMinZoom(), t - 1, function(e) {
                for (var t, i = e._markers, r = i.length - 1; 0 <= r; r--)
                    (t = i[r])._icon && (t._setPos(n),
                    t.clusterHide())
            }, function(e) {
                for (var t, i = e._childClusters, r = i.length - 1; 0 <= r; r--)
                    (t = i[r])._icon && (t._setPos(n),
                    t.clusterHide())
            })
        },
        _recursivelyAnimateChildrenInAndAddSelfToMap: function(t, i, r, n) {
            this._recursively(t, n, i, function(e) {
                ...
                e._isSingleParent() && r - 1 === n ? (e.clusterShow(),
                e._recursivelyRemoveChildrenFromMap(t, i, r)) : e.clusterHide(),
                e._addToMap()
            })
        },
            ...
            this._recursively(s, this._group._map.getMinZoom() - 1, n, function(e) {
                if (n !== e._zoom)
                    for (var t = e._markers.length - 1; 0 <= t; t--) {
                        var i = e._markers[t];
                        s.contains(i._latlng) && (r && (i._backupLatlng = i.getLatLng(),
                        i.setLatLng(r),
        ...
        _recursivelyRemoveChildrenFromMap: function(e, t, i, r) {
            ...
            this._recursively(e, t - 1, i - 1, function(e) {
                for (s = e._markers.length - 1; 0 <= s; s--)
                    n = e._markers[s],
                    r && r.contains(n._latlng) || (e._group._featureGroup.removeLayer(n),
    ...
    L.DistanceGrid.prototype = {
        ...
        removeObject: function(e, t) {
            var i, r, n = this._getCoord(t.x), s = this._getCoord(t.y), t = this._grid, o = t[s] = t[s] || {}, a = o[n] = o[n] || [];
        ...
        eachObject: function(e, t) {
            var i, r, n, s, o, a, h = this._grid;
            for (i in h)
                for (r in o = h[i])
                    for (n = 0,
                    s = (a = o[r]).length; n < s; n++)
                        e.call(t, a[n]) && (n--,
                        s--)
        },
        getNearObject: function(e) {
            for (var t, i, r, n, s, o, a, h = this._getCoord(e.x), l = this._getCoord(e.y), u = this._objectPoint, _ = this._sqCellSize, d = null, p = l - 1; p <= l + 1; p++)
                if (r = this._grid[p])
                    for (t = h - 1; t <= h + 1; t++)
                        if (n = r[t])
                            for (i = 0,
                            s = n.length; i < s; i++)
                                o = n[i],
                                ((a = this._sqDist(u[L.Util.stamp(o)], e)) < _ || a <= _ && null === d) && (_ = a,
                                d = o);
            return d
        },
    ...
    L.QuickHull = {
        ...
        findMostDistantPointFromBaseLine: function(e, t) {
            for (var i, r, n = 0, s = null, o = [], a = t.length - 1; 0 <= a; a--)
                i = t[a],
                0 < (r = this.getDistant(i, e)) && (o.push(i),
                n < r && (n = r,
                s = i));
            return {
                maxPoint: s,
        ...
        buildConvexHull: function(e, t) {
            var i = []
              , t = this.findMostDistantPointFromBaseLine(e, t);
            return t.maxPoint ? (i = i.concat(this.buildConvexHull([e[0], t.maxPoint], t.newPoints))).concat(this.buildConvexHull([t.maxPoint, e[1]], t.newPoints)) : [e[0]]
        },
        getConvexHull: function(e) {
            for (var t, i = !1, r = !1, n = !1, s = !1, o = null, a = null, h = null, l = null, u = null, _ = e.length - 1; 0 <= _; _--) {
                var d = e[_];
            ...
            o) : (u = l,
            h),
            [].concat(this.buildConvexHull([u, t], e), this.buildConvexHull([t, u], e))
        }
    },
    L.MarkerCluster.include({
        getConvexHull: function() {
            for (var e, t = this.getAllChildMarkers(), i = [], r = t.length - 1; 0 <= r; r--)
                e = t[r].getLatLng(),
                i.push(e);
    ...
    L.MarkerCluster.include({
        ...
        spiderfy: function() {
            var e, t;
            this._group._spiderfied === this || this._group._inZoomAnimation || (e = this.getAllChildMarkers(null, !0),
            t = this._group._map.latLngToLayerPoint(this._latlng),
            this._group._unspiderfy(),
            t = (this._group._spiderfied = this)._group.options.spiderfyShapePositions ? this._group.options.spiderfyShapePositions(e.length, t) : e.length >= this._circleSpiralSwitchover ? this._generatePointsSpiral(e.length, t) : (t.y += 10,
            this._generatePointsCircle(e.length, t)),
        ...
        _generatePointsCircle: function(e, t) {
            var i, r, n = this._group.options.spiderfyDistanceMultiplier * this._circleFootSeparation * (2 + e) / this._2PI, s = this._2PI / e, o = [], n = Math.max(n, 35);
            for (o.length = e,
            i = 0; i < e; i++)
        ...
        _generatePointsSpiral: function(e, t) {
            for (var i = this._group.options.spiderfyDistanceMultiplier, r = i * this._spiralLengthStart, n = i * this._spiralFootSeparation, s = i * this._spiralLengthFactor * this._2PI, o = 0, a = [], h = a.length = e; 0 <= h; h--)
                h < e && (a[h] = new L.Point(t.x + r * Math.cos(o),t.y + r * Math.sin(o))._round()),
                r += s / (o += n / r + 5e-4 * h);
            return a
        },
        _noanimationUnspiderfy: function() {
            var e, t, i = this._group, r = i._map, n = i._featureGroup, s = this.getAllChildMarkers(null, !0);
            for (i._ignoreMove = !0,
            this.setOpacity(1),
            t = s.length - 1; 0 <= t; t--)
                e = s[t],
                ...
                e._spiderLeg && (r.removeLayer(e._spiderLeg),
                delete e._spiderLeg);
            i.fire("unspiderfied", {
                cluster: this,
                markers: s
    ...
    L.MarkerClusterNonAnimated = L.MarkerCluster.extend({
        _animationSpiderfy: function(e, t) {
            var i, r, n, s, o = this._group, a = o._map, h = o._featureGroup, l = this._group.options.spiderLegPolylineOptions;
            for (o._ignoreMove = !0,
            i = 0; i < e.length; i++)
    ...
    L.MarkerCluster.include({
        _animationSpiderfy: function(e, t) {
            var i, r, n, s, o, a, h = this, l = this._group, u = l._map, _ = l._featureGroup, d = this._latlng, p = u.latLngToLayerPoint(d), c = L.Path.SVG, f = L.extend({}, this._group.options.spiderLegPolylineOptions), m = f.opacity;
            ...
            i = 0; i < e.length; i++)
                ...
                u.addLayer(n),
                r._spiderLeg = n,
                c && (o = (s = n._path).getTotalLength() + .1,
            ...
            i = e.length - 1; 0 <= i; i--)
                ...
                c && ((s = (n = r._spiderLeg)._path).style.strokeDashoffset = 0,
                n.setStyle({
                    opacity: m
                }));
            this.setOpacity(.3),
        ...
        _animationUnspiderfy: function(e) {
            var t, i, r, n, s, o = this, a = this._group, h = a._map, l = a._featureGroup, u = e ? h._latLngToNewLayerPoint(this._latlng, e.zoom, e.center) : h.latLngToLayerPoint(this._latlng), _ = this.getAllChildMarkers(null, !0), d = L.Path.SVG;
            for (a._ignoreMove = !0,
            a._animationStart(),
            this.setOpacity(1),
            i = _.length - 1; 0 <= i; i--)
                (t = _[i])._preSpiderfyLatlng && (t.closePopup(),
                ...
                s = !1),
                s && l.removeLayer(t),
                d && (s = (n = (r = t._spiderLeg)._path).getTotalLength() + .1,
            ...
            setTimeout(function() {
                ...
                for (i = _.length - 1; 0 <= i; i--)
                    (t = _[i])._spiderLeg && e++;
                for (i = _.length - 1; 0 <= i; i--)
                    (t = _[i])._spiderLeg && (t.clusterShow && t.clusterShow(),
