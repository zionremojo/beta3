    ...
    t.Icon = L.ExtraMarkers.Icon = L.Icon.extend({
        ...
        createIcon: function() {
            var e = document.createElement("div")
              , t = this.options;
            return t.icon && (e.innerHTML = this._createInner()),
            t.innerHTML && (e.innerHTML = t.innerHTML),
            t.bgPos && (e.style.backgroundPosition = -t.bgPos.x + "px " + -t.bgPos.y + "px"),
            t.svg ? this._setIconStyles(e, "svg") : this._setIconStyles(e, t.shape + "-" + t.markerColor),
            e
        },
        ...
        _createInner: function() {
            var e = ""
              ...
              , a = ""
              , r = this.options;
            return r.iconColor && (e = "color: " + r.iconColor + ";"),
            0 !== r.iconRotate && (e += "-webkit-transform: rotate(" + r.iconRotate + "deg);",
            ...
            r.number && (t = 'number="' + r.number + '" '),
            r.extraClasses.length && (o += r.extraClasses + " "),
            r.prefix.length && (o += r.prefix + " "),
            r.icon.length && (o += r.icon + " "),
            r.svg && (a += this._createSvg(r.shape, this._getColorHex(r.markerColor))),
            a += "<i " + t + 'style="' + e + '" class="' + o + '"></i>',
            r.name.length && (a += '<div class="' + (void 0 !== r.nameClasses ? r.nameClasses : "") + '">' + r.name + "</div>"),
            a
        },
        _setIconStyles: function(e, t) {
            var o, a, r = this.options, n = L.point(r["shadow" === t ? "shadowSize" : "iconSize"]);
            a = "shadow" === t ? (o = L.point(r.shadowAnchor || r.iconAnchor),
            "shadow") : (o = L.point(r.iconAnchor),
            "icon"),
            !o && n && (o = n.divideBy(2, !0)),
            e.className = "leaflet-marker-" + a + " extra-marker extra-marker-" + t + " " + r.className,
            o && (e.style.marginLeft = -o.x + "px",
        ...
        createShadow: function() {
            var e = document.createElement("div");
            return this._setIconStyles(e, "shadow"),
            e
        }
    }),
